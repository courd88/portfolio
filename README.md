...
처음 시작 하면서 서로 아이디어를 내고 기획을 하는 부분에서 여러 난관이 있었지만
나름 모두의 마음에 충족 시킬수 있던 프로젝트였습니다
진행과정 중 여러 트러블이 있었지만 서로 의견을 제시하고 대화를 통해 풀어나아가
서로 존중과 배려를 해주어 끝까지 무탈하게 완성시킬수 있었습니다.
